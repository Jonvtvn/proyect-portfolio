  ...
  return (
    <>
      <main className='my-5'>
        ...
        <div className='bg-neutral-900 max-w-6xl mx-auto h-screen rounded-bl-2xl rounded-br-2xl'>
          <div className='grid grid-cols-6 gap-4 px-4 py-4 pt-20'>
            ...
            <aside className='col-span-4 bg-neutral-950 rounded-lg p-5 mr-5'>
